...
/*
 * ks0108-192x64_HJ19264A_Panel.h - User specific configuration for Arduino GLCD library
 *
 * Use this file to set LCD panel parameters
...
#include "AutoPinConfig_ks0108.h"  // config file for standard Arduino using documented wiring
